...
public class Image3D implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		final GL2 gl = drawable.getGL().getGL2();
		 gl.glClear(GL2.GL_COLOR_BUFFER_BIT | GL2.GL_DEPTH_BUFFER_BIT);     // Clear The Screen And The Depth Buffer
			...
			//glu.gluPerspective(0.0, 1.0, 3.0, 7.0);
			gl.glMatrixMode(GL2.GL_MODELVIEW);
			glu.gluLookAt(1.0, 1.0, 1.0, 0.0, -1.0, 0.0, 2.0, 2.0, -1.0);
	...
	public void init(GLAutoDrawable drawable) {
		...
		try{
			File im = new File(IHM.pictures[0].filename);
	...
	public static void lancer() {
		...
		Image3D r = new Image3D();
		glcanvas.addGLEventListener(r);
		glcanvas.setSize(400, 400);
		
		final FPSAnimator animator = new FPSAnimator(glcanvas, 300,true );
		
		final JFrame frame = new JFrame ("Image3D");
	...
	private static void keyBindings(JPanel p, final JFrame frame, final Image3D r) {
